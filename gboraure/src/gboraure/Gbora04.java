...
public void insert() throws  NamingException {   	
    ...
    try {
        ...
        String query = "INSERT INTO GBORA04 VALUES (?,?,?,?,?,?,'" + getFecha() + "',?,'" + getFecha() + "')";
        pstmt = con.prepareStatement(query);
        pstmt.setString(1,vecgra[0].toUpperCase());
        pstmt.setString(2,vecsec[0].toUpperCase());
        pstmt.setString(3,veclot[0].toUpperCase());
        pstmt.setString(4,codtab.toUpperCase());
        pstmt.setString(5,destab.toUpperCase());
...
public void update() throws  NamingException {
	//System.out.println("entre al metodo UPDATE");
     ...
     try { 	 
        ...
        pstmt.setString(5,veclot[0].toUpperCase());
        pstmt.setString(6,codtab.toUpperCase());
   ...
   /**
	 ...
	 **/
		 ...
		 String vquery = "SELECT A.CODLOT|| ' - ' ||A.DESLOT AS LOTE";
		        ...
		        vquery += " AND A.CODSEC = '" + vecsec[0].toUpperCase() + "'";
