...
--------------------------------------------------------
  ...
  CREATE TABLE "ACCCAT4" 
   ...
   COMMENT ON COLUMN "ACCCAT4"."USRCRE" IS 'Usuario de creacion de registro';
   COMMENT ON COLUMN "ACCCAT4"."FECCRE" IS 'Fecha de creacion de registro';
   COMMENT ON COLUMN "ACCCAT4"."USRACT" IS 'Usuario de actualizacion de registro';
...
--------------------------------------------------------
  ...
  CREATE TABLE "BVT001A" 
   ...
   COMMENT ON TABLE "BVT001A"  IS 'Agruparcion de reportes';
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "BVT002" 
   (	"CODUSER" VARCHAR2(10 BYTE), 
	...
	"INSTANCIA" NUMBER(*,0) DEFAULT NULL
   ) ;
   ...
   COMMENT ON COLUMN "BVT002"."MAIL" IS 'DIRECCION DE CORREO ELECTRONICO';
...
--------------------------------------------------------
  ...
  CREATE TABLE "BVTCAT4" 
   ...
   COMMENT ON COLUMN "BVTCAT4"."DESCAT4" IS 'Descripcion categoria 4';
...
--------------------------------------------------------
  ...
  CREATE TABLE "BVTPARAMS_NUMBER_TEMP" 
   ...
   COMMENT ON COLUMN "BVTPARAMS_NUMBER_TEMP"."CODREP" IS 'Codigo del reporte';
   COMMENT ON COLUMN "BVTPARAMS_NUMBER_TEMP"."SESSIONID" IS 'Id de la session';
   COMMENT ON COLUMN "BVTPARAMS_NUMBER_TEMP"."PARAMNUMBER" IS 'Numero de parametros';
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "BVTPARAMS_TEMP" 
   (	"CODREP" VARCHAR2(10 BYTE), 
	...
	"PARAMHIDDEN" VARCHAR2(5 BYTE), 
	"PARAMREQUIRED" VARCHAR2(5 BYTE)
   ) ;

   COMMENT ON COLUMN "BVTPARAMS_TEMP"."CODREP" IS 'Codigo del reporte';
   COMMENT ON COLUMN "BVTPARAMS_TEMP"."PARAMNAME" IS 'Nombre del parametro';
   COMMENT ON COLUMN "BVTPARAMS_TEMP"."PARAMTYPE" IS 'Tipo del parametro';
   COMMENT ON COLUMN "BVTPARAMS_TEMP"."SESSIONID" IS 'Id de la session';
   COMMENT ON COLUMN "BVTPARAMS_TEMP"."PROMPTEXT" IS 'Descripcion del parametro';
...
--------------------------------------------------------
  ...
  CREATE TABLE "INSTANCIAS" 
   ...
   COMMENT ON COLUMN "INSTANCIAS"."INSTANCIA" IS 'Codigo';
   COMMENT ON COLUMN "INSTANCIAS"."DESCRIPCION" IS 'Descripcion';
   COMMENT ON COLUMN "INSTANCIAS"."USRCRE" IS 'Usuario de creacion de registro';
   COMMENT ON COLUMN "INSTANCIAS"."FECCRE" IS 'Fecha de creacion de registro';
   COMMENT ON COLUMN "INSTANCIAS"."USRACT" IS 'Usuario de actualizacion de registro';
   COMMENT ON COLUMN "INSTANCIAS"."FECACT" IS 'Fecha de actualizacion de registro';
...
--------------------------------------------------------
  ...
  CREATE TABLE "INSTANCIAS_USR" 
   ...
   COMMENT ON COLUMN "INSTANCIAS_USR"."CODUSER" IS 'Codigo de usuario';
   COMMENT ON COLUMN "INSTANCIAS_USR"."INSTANCIA" IS 'Instancias';
   COMMENT ON COLUMN "INSTANCIAS_USR"."USRCRE" IS 'Usuario de creacion de registro';
   COMMENT ON COLUMN "INSTANCIAS_USR"."FECCRE" IS 'Fecha de creacion de registro';
   COMMENT ON COLUMN "INSTANCIAS_USR"."USRACT" IS 'Usuario de actualizacion de registro';
   COMMENT ON COLUMN "INSTANCIAS_USR"."FECACT" IS 'Fecha de actualizacion de registro';
...
--------------------------------------------------------
  ...
  CREATE TABLE "T_PROGRAMACION" 
   ...
   COMMENT ON COLUMN "T_PROGRAMACION"."ACTIVA" IS 'INDICA SI LA TAREA ESTA ACTIVA O NO. 0-ACTIVA, 1-INACTIVA';
   ...
   COMMENT ON COLUMN "T_PROGRAMACION"."OPCTAREAS" IS 'OPCIONES DE TAREAS: 1-ENVIA REPORTES A LISTA DE CORREO, 2-ENVIA REPORTES A RUTA, 3-ENVIA REPORTES A LISTA PERSONALIZADA';
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "BVT003_PK" ON "BVT003" ("CODROL", "INSTANCIA") 
  ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "BVT001" MODIFY ("CODGRUP" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "BVT002" MODIFY ("INSTANCIA" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "BVTPARAMS_TEMP" MODIFY ("PARAMREQUIRED" NOT NULL ENABLE);
  ALTER TABLE "BVTPARAMS_TEMP" MODIFY ("PARAMHIDDEN" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "BVT001" ADD CONSTRAINT "BVT001_FK1" FOREIGN KEY ("INSTANCIA")
	  REFERENCES "INSTANCIAS" ("INSTANCIA") ENABLE;
  ALTER TABLE "BVT001" ADD CONSTRAINT "BVT001_FK2" FOREIGN KEY ("CODGRUP", "INSTANCIA")
	  REFERENCES "BVT001A" ("CODGRUP", "INSTANCIA") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "BVT002" ADD CONSTRAINT "BVT002_FK1" FOREIGN KEY ("INSTANCIA")
	  REFERENCES "INSTANCIAS" ("INSTANCIA") ENABLE;
  ALTER TABLE "BVT002" ADD CONSTRAINT "BVT002_FK2" FOREIGN KEY ("B_CODROL", "INSTANCIA")
