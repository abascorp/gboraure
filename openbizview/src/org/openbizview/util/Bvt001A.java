...
import org.primefaces.model.SortOrder;
	...
	public class Bvt001A extends Bd implements Serializable {
		...
		public Bvt001A() throws ClassNotFoundException, SQLException, NamingException{
    ...
    public void delete() throws NamingException  {  
    	...
    	if (chkbox==null){
	        ...
	        try {
	        	...
	        	String query = "DELETE from Bvt001A WHERE codgrup in (" + param + ")";
     ...
     try {	
    	Context initContext = new InitialContext();     
 		...
 		String query = "";
  		...
  		switch ( productName ) {
        case "Oracle":
        	 query = "SELECT count_bvt001a('" + ((String) filterValue).toUpperCase() + "') from dual";
             break;
        case "PostgreSQL":
